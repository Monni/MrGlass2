...
public:
	...
	void checkmovement();										// Tarkistetaan pelaajan n‰pp‰inpainallukset ja toimitaan sen mukaan. Tarkistaa myˆs hypyn ja painovoiman tilan ja liikuttaa glassmania sen mukaan
